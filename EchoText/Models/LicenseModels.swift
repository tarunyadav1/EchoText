...
enum ProFeature: String, CaseIterable {
    case largeModels = "large_models"           // Large and large-v3 models
    case unlimitedRecording = "unlimited_recording"
    case autoInsert = "auto_insert"             // Auto-insert text into apps
    ...
    var description: String {
        switch self {
        case .largeModels:
            return "Access to large and large-v3 models for highest accuracy"
        case .unlimitedRecording:
            return "No time limits on recordings"
        case .autoInsert:
            return "Automatically insert transcribed text into any app"
        case .speakerDiarization:
            return "Identify and label different speakers"
        case .batchTranscription:
            return "Transcribe multiple files at once"
        case .watchFolder:
            return "Automatically transcribe files added to a folder"
        case .prioritySupport:
            return "Get priority support via email"
        }
    }
}
