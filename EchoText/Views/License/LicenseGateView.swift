    ...
    private var optionsView: some View {
        VStack(spacing: 14) {
            ...
            Button {
                ...
                .background(
                    RoundedRectangle(cornerRadius: DesignSystem.CornerRadius.medium)
                        .fill(isHoveringActivate ? DesignSystem.Colors.surfaceHover : DesignSystem.Colors.surface)
                )
                .overlay(
                    RoundedRectangle(cornerRadius: DesignSystem.CornerRadius.medium)
            ...
            Button {
                ...
                .background(
                    RoundedRectangle(cornerRadius: DesignSystem.CornerRadius.medium)
                        .fill(isHoveringBuy ? DesignSystem.Colors.surfaceHover : DesignSystem.Colors.surface)
                )
                .overlay(
                    RoundedRectangle(cornerRadius: DesignSystem.CornerRadius.medium)
                        .stroke(DesignSystem.Colors.border, lineWidth: 1)
                ...
                TextField("Enter your license key", text: $licenseKey)
                    ...
                    .overlay(
                        RoundedRectangle(cornerRadius: DesignSystem.CornerRadius.small)
                            .stroke(errorMessage != nil ? DesignSystem.Colors.error : DesignSystem.Colors.border, lineWidth: 1)
                    )
                    .onSubmit { activate() }
